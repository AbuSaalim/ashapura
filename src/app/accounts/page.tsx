  ...
  return (
    <div className="max-w-7xl mx-auto pb-12 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Accounts, MahaRERA Demands & Society Ledger</h1>
        ...
        <button 
          ...
          className="bg-slate-900 hover:bg-slate-800 text-white px-5 py-2.5 rounded-xl font-semibold text-xs transition-colors flex items-center shadow-xs"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-emerald-50/80 border border-emerald-200 p-5 rounded-2xl shadow-xs">
          ...
          <p className="text-3xl font-black text-emerald-950">{formatPrice(18420000)}</p>
        ...
        <div className="bg-amber-50/80 border border-amber-200 p-5 rounded-2xl shadow-xs">
          ...
          <p className="text-3xl font-black text-amber-950">{formatPrice(4600000)}</p>
          <p className="text-xs text-amber-700 mt-1 font-medium">Construction linked notices due this month</p>
        </div>

        <div className="bg-purple-50/80 border border-purple-200 p-5 rounded-2xl shadow-xs">
          <div className="flex items-center justify-between mb-3">
          ...
          <p className="text-3xl font-black text-purple-950">{formatPrice(1800000)}</p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-200 text-slate-500 text-xs uppercase tracking-wider font-bold bg-slate-50/40">
                <th className="py-3.5 px-6">Demand Notice ID</th>
                <th className="py-3.5 px-6">Project & Unit</th>
                <th className="py-3.5 px-6">Allottee / Payee</th>
                <th className="py-3.5 px-6">Milestone Scope</th>
                <th className="py-3.5 px-6">Amount (INR)</th>
                <th className="py-3.5 px-6">Due Date</th>
                <th className="py-3.5 px-6">Ledger Status</th>
                <th className="py-3.5 px-6 text-right">Dispatch Notice</th>
              </tr>
            </thead>
          ...
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="p-4 border-b border-slate-100 bg-slate-50/60 rounded-xl mb-4">
                <h2 className="text-base font-bold text-slate-800">Trigger New Demand Notice</h2>
                <p className="text-xs text-slate-500">Dispatch construction milestone or society transit rent</p>
              </div>
              <form onSubmit={handleTriggerDemand} className="space-y-3.5 text-xs">
                <div>
